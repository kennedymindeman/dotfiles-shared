...
Copy this directory into a new **employer-owned private** repository. It has no
...
locally. Replace or remove `agents/work.md` to match the team's actual rules.
...
for extra configuration the team needs; do not copy shared files into the overlay.
...
Git, using the employer's approved credential storage.
